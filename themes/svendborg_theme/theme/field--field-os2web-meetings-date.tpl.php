...
HTML comment.
-->
<?php $meeting_date = $element['#object']->field_os2web_meetings_date['und'][0]['value']; ?>
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="field-items"<?php print $content_attributes; ?>>
    <?php foreach ($items as $delta => $item): ?>
      ...
      <?php 
       print format_date(strtotime($meeting_date.'UTC'), 'custom', '\D\e\n\ d. F Y - k\l\. H:i', date_default_timezone_get()) ?>
      </div>
    <?php endforeach; ?>
  </div>
</div>
