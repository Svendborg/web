...
//we don't want to show the node view, therefore redirecting to the actual file
if (isset($variables['field_os2search_file_ref'])) {
  drupal_goto(file_create_url($variables['field_os2search_file_ref'][0]['uri']));
}
?>
